...
function PopupWindow_isClicked(e) {
	if (this.divName != null) {
		if (this.use_layers) {
			...
			while (typeof t.parentElement != 'undefined' && t.parentElement != null) {
...
function CP_tmpReturnFunction(y,m,d) { 
	if (window.CP_targetInput!=null) {
		...
		if (window.CP_targetInput.onchange) window.CP_targetInput.onchange();if (window.CP_targetInput.onblur) window.CP_targetInput.onblur();
		}
	else {
...
//--- Validacion fecha
        ...
        function validar_fecha (str_date, mostrar_error) 
        {
            ...
            if (arr_date[1] < 1 || arr_date[1] > 12) return cal_error ("Inválido Valor para el Mes: '" + arr_date[1] + "'. Rango Permitido 01-12.", mostrar_error);
            ...
            if (dt_date.getMonth() != (arr_date[1]-1)) return cal_error ("Inválido Día del Mes: '" + arr_date[0] + "'. Rango Permitido 01-"+dt_numdays.getDate()+".", mostrar_error);
