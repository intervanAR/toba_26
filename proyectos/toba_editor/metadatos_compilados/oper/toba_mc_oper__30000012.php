...
class toba_mc_comp__30000037
{
  ...
  array (
    0 => 
    array (
      'objeto_ei_formulario_fila' => 30000026,
      'objeto_ei_formulario' => 30000037,
      ...
      'descripcion' => 'Nombre del archivo o parte del path, se puede usar expresiones regulares de preg_match',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => NULL,
    ...
    1 => 
    array (
      'objeto_ei_formulario_fila' => 30000027,
      'objeto_ei_formulario' => 30000037,
      'objeto_ei_formulario_proyecto' => 'toba_editor',
      'identificador' => 'convenciones',
      'elemento_formulario' => 'ef_checkbox',
      'columnas' => 'convenciones',
      'obligatorio' => 0,
      'oculto_relaja_obligatorio' => 0,
      'orden' => '2',
      'etiqueta' => 'Analizar Convenciones',
      'etiqueta_estilo' => NULL,
      'descripcion' => 'Para cada archivo del proyecto muestra un detalle de errores o advertencias sobre los estándares y convenciones de programación.',
      'colapsado' => 0,
      'desactivado' => 0,
      'estilo' => NULL,
      'total' => NULL,
