...
class toba_mc_item__1000256
{
  ...
  array (
    ...
    'item' => '1000256',
    'item_nombre' => 'Editor ei_formulario_ml',
    'item_descripcion' => 'Un [wiki:Referencia/Objetos/ei_formulario_ml formulario_ml] presenta una grilla de campos editables repetidos una cantidad dada de filas. permitiendo recrear la carga de distintos registros con la misma estructura. La definición y uso de la grilla de campos es similar al  [wiki:Referencia/Objetos/ei_formulario formulario simple] con el agregado de lógica para manejar un número arbitrario de filas.',
  ...
  array (
    ...
    array (
      ...
      'objeto' => 1386,
      'objeto_nombre' => 'Editor OBJETO - ei_formulario_ml',
      'objeto_subclase' => 'ci_principal',
      'objeto_subclase_archivo' => 'objetos_toba/ei_formulario_ml/ci_principal.php',
      'orden' => 0,
      'clase_proyecto' => 'toba',
      'clase' => 'toba_ci',
